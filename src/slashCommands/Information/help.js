...
module.exports = {
  ...
  const embed = new EmbedBuilder()
    ...
    let but1 = new ButtonBuilder().setCustomId("home").setLabel("<:generalinfo:1038650795249373184>").setStyle(ButtonStyle.Primary)
  
    let but2 = new ButtonBuilder().setCustomId("music").setLabel("Music").setStyle(ButtonStyle.Danger)
  
    let but3 = new ButtonBuilder().setCustomId("info").setLabel("Info").setStyle(ButtonStyle.Primary);

    let but4 = new ButtonBuilder().setCustomId("playlist").setLabel("Playlist").setStyle(ButtonStyle.Danger);
